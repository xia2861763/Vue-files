                  ...
                  <div class="item-quantity">
                    <div class="select-self select-self-open">
                      <div class="quantity" style="display: flex">
                        ...
                        <input
                          style="width: 20px;margin: 0px 8px 0px 8px"
                          type="text"
                          value="0"
                          disabled
                        >
        ...
        <div class="cart-foot-wrap">
          ...
          <div class="cart-foot-r">
            ...
            <div class="next-btn-wrap">
              <a href="javascrit:;" class="btn btn--red" style="width: 200px" @click="cartView()">结账</a>
            </div>
          </div>
        </div>
      </div>
...
<style src="./src/css/base.css"></style>
<style src="./src/css/reset.css"></style>
<style src="./src/css/checkout.css"></style>
<style src="./src/css/modal.css"></style>
<style scoped>
.quentity input {
  width: 40px;
  padding: 5px 10px;
